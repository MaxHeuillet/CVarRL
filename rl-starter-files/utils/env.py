...
class StochasticDistShiftEnv(DistShiftEnv):
    ...
    def __init__( self, cost=0.7, width=12,  height=9,  agent_start_pos=np.array((1, 1)),  agent_start_dir=0, strip2_row=2, adversary_budget=1.0):
        ...
        super().__init__(  width=width,  height=height,  agent_start_pos=agent_start_pos,  agent_start_dir=agent_start_dir,  strip2_row=strip2_row)
