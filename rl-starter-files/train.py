...
parser.add_argument("--budget", required=True,
                    help="budget for the adversary")
parser.add_argument("--stochasticity", required=True,
                    help="stochasticity of the actions taken")
...
algo = torch_ac.PPOAlgo(envs, acmodel, acmodel_adversary, args.stochasticity , device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                            args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                            args.optim_eps, args.clip_eps, args.epochs, args.batch_size, preprocess_obss)

adversary_algo = torch_ac.AdversaryPPOAlgo(envs, acmodel, acmodel_adversary, args.stochasticity ,  device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                            args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                            args.optim_eps, args.clip_eps, args.epochs, args.batch_size, preprocess_obss)
...
while num_frames < args.frames:
    ...
    batch = np.divide(batch_perturbation_map, batch_counter_map, out=np.zeros_like(batch_perturbation_map), where=batch_counter_map!=0)
    total = np.divide(algo.perturbation_map, algo.counter_map , out=np.zeros_like(algo.perturbation_map), where=algo.counter_map !=0)
    ...
    if update % 3 == 0 :
        ...
        logs3 = adversary_algo.update_parameters(exps)
    ...
    if args.save_interval > 0 and update % args.save_interval == 0:
        ...
        status = {"num_frames": num_frames, "update": update,
                  ...
                  "adv_model_state": acmodel_adversary.state_dict(), "adv_optimizer_state": adversary_algo.optimizer.state_dict() }
